...
import { archivePost, createPost, deletePost, getAdminPost, listAdminPosts, listPostRevisions, requireAdmin, updatePost } from "./admin";
...
app.get("/api/v1/admin/posts/:slug", getAdminPost);
